...
\restrict kY6LDjgGTvFLdBe6FY8TCgcKwsiL4tTUWuQQvkg2tbyyVKBujYHimcMaYkGf6PY
...
--
-- Name: film_work_genre_idx; Type: INDEX; Schema: content; Owner: app
--
...
--
-- Name: film_work_title_idx; Type: INDEX; Schema: content; Owner: app
--
...
--
-- Name: genre_name_idx; Type: INDEX; Schema: content; Owner: app
--

CREATE INDEX genre_name_idx ON content.genre USING btree (name);


--
-- Name: person_fill_name_idx; Type: INDEX; Schema: content; Owner: app
--

CREATE INDEX person_fill_name_idx ON content.person USING btree (full_name);
...
ALTER TABLE ONLY content.genre_film_work
    ADD CONSTRAINT genre_film_work_film_work_id_fkey FOREIGN KEY (film_work_id) REFERENCES content.film_work(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY content.genre_film_work
    ADD CONSTRAINT genre_film_work_genre_id_fkey FOREIGN KEY (genre_id) REFERENCES content.genre(id) ON UPDATE CASCADE ON DELETE CASCADE;
